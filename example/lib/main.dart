          ...
          child: Column(
            ...
            children: [
              ...
              const Row(
                ...
                children: [
                  M3XCircularWavyLoadingIndicator(size: 32),
                  SizedBox(width: 24),
                  M3XCircularWavyLoadingIndicator(size: 32, forceWavy: true),
                  SizedBox(width: 24),
                  M3XCircularWavyLoadingIndicator(size: 64),
                  SizedBox(width: 24),
                  M3XCircularWavyLoadingIndicator(size: 96),
                ],
              ),
              const SizedBox(height: 32),
